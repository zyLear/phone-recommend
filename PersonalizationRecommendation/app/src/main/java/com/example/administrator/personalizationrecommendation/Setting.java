...
public class Setting extends AppCompatActivity {
        ...
        public void handleMessage(Message message) {
            try {
                ...
                switch (jsonObject.getString("gender")) {
                    case "male":male.setChecked(true);break;
                    case "female":female.setChecked(true);break;
                }
                switch (jsonObject.getString("status")) {
                    case "student":student.setChecked(true);break;
                    case "working":working.setChecked(true);break;
                    case "other":other.setChecked(true);break;
                }
    ...
    private String getGender(){
        ...
        switch (gender.getCheckedRadioButtonId()) {
            case R.id.settingMale:result="male"; break;
            case R.id.settingFemale:result="female";break;
        }
        return result;
    }
    ...
    private String getStatus(){
        ...
        switch (status.getCheckedRadioButtonId()) {
            case R.id.settingStudent:result="student";break;
            case R.id.settingWorking:result="working";break;
            case R.id.settingOther:result="other";break;
        }
        return result;
    }
